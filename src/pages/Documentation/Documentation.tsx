...
import PageNavs from "../../components/PageNavs/PageNavs"
...
export default function Documentation() {
  ...
  const links = [
    { label: "Document 1", code: "Document 1", url: "document1", title: "Document 1" },
  ...
  const handleClick=()=>{
    setPages([{ label: "Link 15", code: "link15", url: "link", title: "Link 15" }]);
  }
  return (
    <>
